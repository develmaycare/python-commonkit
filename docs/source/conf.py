# -*- coding: utf-8 -*-
#
# Python Common Kit documentation build configuration file, created by
...
htmlhelp_basename = 'PythonCommonKitDoc'
...
# man_pages = [
#     (master_doc, 'sixgun', u'Python Common Kit Documentation',
#      [author], 1)
# ]
